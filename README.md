...
💡 Engenheiro Biomédico | Cientista de Dados | Entusiasta em IA  

---

## 💡 Sobre mim
Sou engenheiro biomédico com foco em Ciência de Dados e Inteligência Artificial,  
atuando no desenvolvimento de soluções baseadas em dados, modelagem estatística  
e automação de processos.

Tenho interesse especial na aplicação de IA na área da saúde, buscando gerar  
insights relevantes e soluções inovadoras.
...
🔹 Em construção — em breve projetos publicados aqui!
...
[![Portfólio](https://img.shields.io/badge/-Portfólio-181717?logo=github&logoColor=white&style=flat)](https://luizlampreia.github.io)
